// bundled from https://github.com/feross/buffer V 6.0.3

// prettier-ignore
for(var t={},e={byteLength:function(t){var e=u(t),r=e[0],n=e[1];return 3*(r+n)/4-n},toByteArray:function(t){var e,r,i=u(t),f=i[0],s=i[1],h=new o(function(t,e,r){return 3*(e+r)/4-r}(0,f,s)),a=0,c=s>0?f-4:f;for(r=0;r<c;r+=4)e=n[t.charCodeAt(r)]<<18|n[t.charCodeAt(r+1)]<<12|n[t.charCodeAt(r+2)]<<6|n[t.charCodeAt(r+3)],h[a++]=e>>16&255,h[a++]=e>>8&255,h[a++]=255&e;2===s&&(e=n[t.charCodeAt(r)]<<2|n[t.charCodeAt(r+1)]>>4,h[a++]=255&e);1===s&&(e=n[t.charCodeAt(r)]<<10|n[t.charCodeAt(r+1)]<<4|n[t.charCodeAt(r+2)]>>2,h[a++]=e>>8&255,h[a++]=255&e);return h},fromByteArray:function(t){for(var e,n=t.length,o=n%3,i=[],f=16383,s=0,u=n-o;s<u;s+=f)i.push(h(t,s,s+f>u?u:s+f));1===o?(e=t[n-1],i.push(r[e>>2]+r[e<<4&63]+"==")):2===o&&(e=(t[n-2]<<8)+t[n-1],i.push(r[e>>10]+r[e>>4&63]+r[e<<2&63]+"="));return i.join("")}},r=[],n=[],o="undefined"!=typeof Uint8Array?Uint8Array:Array,i="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",f=0,s=i.length;f<s;++f)r[f]=i[f],n[i.charCodeAt(f)]=f;
function u(t) {
  var e = t.length;
  if (e % 4 > 0)
...
var a = {
  ...
  // prettier-ignore
  read:function(t,e,r,n,o){var i,f,s=8*o-n-1,u=(1<<s)-1,h=u>>1,a=-7,c=r?o-1:0,p=r?-1:1,l=t[e+c];for(c+=p,i=l&(1<<-a)-1,l>>=-a,a+=s;a>0;i=256*i+t[e+c],c+=p,a-=8);for(f=i&(1<<-a)-1,i>>=-a,a+=n;a>0;f=256*f+t[e+c],c+=p,a-=8);if(0===i)i=1-h;else{if(i===u)return f?NaN:1/0*(l?-1:1);f+=Math.pow(2,n),i-=h}return(l?-1:1)*f*Math.pow(2,i-n)},
      ...
      e = Math.abs(e),
        isNaN(e) || e === 1 / 0
          ...
          : ((f = Math.floor(Math.log(e) / Math.LN2)),
            ...
            (e += f + c >= 1 ? p / u : p * Math.pow(2, 1 - c)) * u >= 2 &&
              (f++, (u /= 2)),
            f + c >= a
              ? ((s = 0), (f = a))
              : f + c >= 1
              ? ((s = (e * u - 1) * Math.pow(2, o)), (f += c))
              : ((s = e * Math.pow(2, c - 1) * Math.pow(2, o)), (f = 0)));
      o >= 8;
      t[r + l] = 255 & s, l += y, s /= 256, o -= 8
    );
    for (
      f = (f << o) | s, h += o;
      h > 0;
      t[r + l] = 255 & f, l += y, f /= 256, h -= 8
    );
    t[r + l - y] |= 128 * g;
  },
};
...
!(function (t) {
  ...
  function u(t, e, r) {
    ...
    const o = (function (t) {
      ...
      if (void 0 !== t.length)
        return "number" != typeof t.length || Z(t.length) ? f(0) : p(t);
  ...
  (t.kMaxLength = i),
    ...
    (s.compare = function (t, e) {
      if (
        ...
        J(e, Uint8Array) && (e = s.from(e, e.offset, e.byteLength)),
    ...
    (s.concat = function (t, e) {
      ...
      for (r = 0; r < t.length; ++r) {
        ...
        if (J(e, Uint8Array))
          o + e.length > n.length
            ? (s.isBuffer(e) ||
                (e = s.from(e.buffer, e.byteOffset, e.byteLength)),
              e.copy(n, o))
  ...
  (s.prototype.slice = function (t, e) {
    ...
    (s.prototype.readUint16LE = s.prototype.readUInt16LE =
      function (t, e) {
        return (
          (t >>>= 0), e || C(t, 2, this.length), this[t] | (this[t + 1] << 8)
        );
      }),
    (s.prototype.readUint16BE = s.prototype.readUInt16BE =
      function (t, e) {
        return (
          (t >>>= 0), e || C(t, 2, this.length), (this[t] << 8) | this[t + 1]
        );
      }),
      ...
      throw (
        ((o =
          i > 3
            ...
            : `>= ${e}${n} and <= ${r}${n}`),
        new j.ERR_OUT_OF_RANGE("value", o, t))
      );
    }
    !(function (t, e, r) {
      Y(e, "offset"),
  ...
  function G(t, e, r) {
    if (Math.floor(t) !== t)
      throw (Y(t, r), new j.ERR_OUT_OF_RANGE(r || "offset", "an integer", t));
