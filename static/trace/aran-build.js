(function () {
...
})()(
  {
    ...
    2: [
                ...
                tag === "program" || tag === "eval"
                  ...
                  : ArrayLite.concat(
                      ...
                      tag === "switch" &&
                        ArrayLite.every(
                          statements,
                          (statement) => statement[0] !== "Case" || statement[1]
                        )
                        ? Build.Case(null)
                        : [],
                      trap.Leave(serial)
      ...
      { "../build": 11, "./escape.js": 3, "./visit.js": 8, "array-lite": 35 },
    ],
    3: [
      function (require, module, exports) {
    ...
    4: [
      ...
      { "../build": 11, "./escape": 3, "./visit.js": 8, "array-lite": 35 },
    ],
    5: [
      function (require, module, exports) {
      ...
      function (require, module, exports) {
        ...
        module.exports = (pointcut, nodes) => {
          ...
          ArrayLite.forEach(Enumeration.InformerTrap, (name) => {
            ...
            trap[
              char + Reflect_apply(String_prototype_substring, name, [1])
            ] = function () {
              const serial = arguments[arguments.length - 1];
          ...
          (function () {
                  ...
                  Build.conditional(
                    ...
                    Build.conditional(
                      Build.apply(
                        Build.builtin("Reflect.get"),
                        Build.primitive(void 0),
                        [Build.read(token), Build.builtin("Symbol.unscopables")]
                      ),
                      Build.apply(
                        Build.builtin("Reflect.get"),
                        Build.primitive(void 0),
            ...
            exports.initialize = (
              ...
              return Build.write(
                identifier,
                expression1,
                Build.write(binding.sticker, Build.primitive(true), expression2)
              );
            };
    ...
    28: [
      ...
      { "../build.js": 22, "../visit": 31, "./index.js": 27, "array-lite": 35 },
    ],
    29: [
      function (require, module, exports) {
        const ArrayLite = require("array-lite");
                  ...
                  Scope.write(
                    ...
                    Build.apply(
                      Build.apply(
                        Build.builtin("Reflect.get"),
                        Build.primitive(void 0),
                        [Scope.read(scope, "iterator"), Build.primitive("next")]
                      ),
