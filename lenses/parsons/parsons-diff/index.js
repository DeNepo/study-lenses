...
<body>
  ...
  <br>
  <div style="display: flex; display: row;">
    ...
    <form id='role' style='margin-left: 1em; border-left: 1px black;'>
      <input name='showDiff' id='mandatory-id' type='checkbox' />
      <label for='mandatory-id'>show diff</label>
    </form>
  </div>
  ...
  <script src='${config.ownStatic}/diff/scramblings.js'></script>
  <script src='${config.ownStatic}/diff/randomize-variables.js'></script>
  <script src='${config.ownStatic}/diff/monacoing.js'></script>
  <script src='${config.ownStatic}/diff/init.js'></script>
